...
<thead> 
 ...
 for($i=$min; $i<$max;$i++)
 {
   ?> 
    ...
    <button type="submit" class="suivant" ><a href="menu.php?PAGES=ListeJoueurs&page=<?=$page+1?>">suivant</a> </button>
    <button type="submit" class="precedent" ><a href="menu.php?PAGES=ListeJoueurs&page=<?=$page-1?>">precedent</a> </button>
</div>
	</div>